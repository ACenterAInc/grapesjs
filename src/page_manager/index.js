...
module.exports = () => {
  ...
  return {
       ...
       * @param  {string} id Block id
       * @example
       * var block = PageManager.get('h1-block');
      ...
      render() {
        ...
        /*$(".page-view-selection").bind('display', function(e) {
