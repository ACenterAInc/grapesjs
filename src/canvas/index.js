module.exports = () => {
  ...
  return {
    ...
    init(config) {
      ...
      if(cm) {
        this.setWrapper(cm);
        this.setWrapperPreview(cm);
        this.setWrapperCodeEdit(cm);
      }
    ...
    setWrapperPreview(wrp) {
      canvas.set('wrapperPreview', wrp);
    },
    setWrapperCodeEdit(wrp) {
      canvas.set('wrapperCodeEdit', wrp);
    },
