...
module.exports = () => {
  ...
  AssetsView = require('./view/FilesView'),
  ...
  return {
     ...
     * FileManager.add('http://img.jpg');
     * FileManager.add(['http://img.jpg', './path/to/img.png']);
     *
     ...
     * @example
     * var asset = FileManager.get('http://img.jpg');
     */
    get(src) {
     ...
     * @return {this}
     * @example
     * FileManager.remove('http://img.jpg');
     */
    remove(src) {
